...
public class RaiseIntakeHalfway extends Command {
    private final IntakePivot m_Intake;
    private final Timer m_Timer = new Timer();

    public RaiseIntakeHalfway(IntakePivot deployIntake) {
    ...
    public boolean isFinished() {
        ...
        // TODO: Add encoder-based position detection
        return m_Timer.hasElapsed(MotorConstants.kRaiseIntakeHalfwayTimeout);
    }
