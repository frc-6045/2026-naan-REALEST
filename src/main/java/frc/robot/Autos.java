...
public class Autos {
  ...
  public Autos(Intake intake, IntakePivot intakePivot, Spindexer spindexer, Flywheel flywheel, TopRoller topRoller, Feeder feeder, Swerve swerve) {
    ...
    m_autoChooser.addOption("RIGHT small midlength", AutoBuilder.buildAuto("RIGHT small midlength"));
    ...
    m_autoChooser.addOption("LEFT small midlength", AutoBuilder.buildAuto("LEFT small midlength"));
